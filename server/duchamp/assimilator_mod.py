...
from utils import retry_on_exception, make_path
from utils.amazon import S3Helper, get_file_upload_key
from utils.logger import config_logger

from boinc_sourcefinder.server.config.database_duchamp import CUBE, RESULT
...
def get_assimilator(AssimilatorBase):
    ...
    class SourcefinderAssimilator(AssimilatorBase):

        def __init__(self, config, args):
            AssimilatorBase.__init__(self, args)
            self.sourcefinder_config = config
    ...
    return SourcefinderAssimilator
...
# import sys
#
# from assimilator import SourcefinderAssimilator
#
# if __name__ == "__main__":
#     asm = SourcefinderAssimilator()
#     asm.run_flat_files(sys.argv[1])
