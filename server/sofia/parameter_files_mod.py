...
SOFIA_CONFIG = [
    ...
    ConfigItem("SCfind.threshold", ["3.0", "4.0", "5.0"]),
    ...
    ConfigItem("merge.radiusX", ["1", "3", "5"]),
    ConfigItem("merge.radiusY", ["1", "3", "5"]),
    ConfigItem("merge.radiusZ", ["1", "3", "5"]),
    ConfigItem("merge.minSizeX", ["3", "5", "10"]),
    ConfigItem("merge.minSizeY", ["3", "5", "10"]),
    ConfigItem("merge.minSizeZ", ["3", "5", "10"]),
    ConfigItem("merge.positivity", "false"),

    ConfigItem("parameters.fitBusyFunction", "false"),
    ConfigItem("parameters.optimiseMask", "false"),
    ConfigItem("parameters.dilateMask", ["true", "false"]),
    ...
    ConfigItem("reliability.scaleKernel", ["0.4", "0.5", "0.6"]),
    ...
    ConfigItem("reliability.threshold", "0.5"),
