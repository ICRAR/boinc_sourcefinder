...
SOFIA_CONFIG = [
    ...
    ConfigItem("steps.doSCfind", ["true", "false"]),
    ConfigItem("steps.doThreshold", ["false", "true"]),
    ConfigItem("steps.doWavelet", ["false", "true"]),
    ConfigItem("steps.doCNHI", "false"),
    ConfigItem("steps.doMerge", ["true", "false"]),
    ConfigItem("steps.doReliability", ["true", "false"]),
    ConfigItem("steps.doParameterise", ["true", "false"]),
    ConfigItem("steps.doWriteFilteredCube", "false"),
    ConfigItem("steps.doWriteMask", "false"),
    ConfigItem("steps.doWriteCat", "true"),
    ConfigItem("steps.doMom0", ["true", "false"]),
    ConfigItem("steps.doMom1", ["true, false"]),
