...
INIT_FAIL_PATH = 'validator_tests/duchamp/init/fail/'
INIT_SUCCEED_PATH = 'validator_tests/duchamp/init/succeed/'
COMPARE_FAIL_PATH = 'validator_tests/duchamp/compare/fail/'
COMPARE_SUCCEED_PATH = 'validator_tests/duchamp/compare/succeed/'


def run_init(filename):
    return subprocess.call(['../server/duchamp/validator_duchamp_init.sh', filename, "0"])
