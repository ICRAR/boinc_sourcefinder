...
def parse_args():
    ...
    parser.add_argument('input_folder', metavar='IN', type=str, nargs='1')
    parser.add_argument('parameter_folder', metavar='PARAM', type=str, nargs='1')
    parser.add_argument('output_folder', metavar='OUT', type=str, default='.')
...
def main():
    ...
    param_files = [f for f in os.listdir(args['parameter_folder']) if f.endswith('.par')]
